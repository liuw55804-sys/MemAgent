...
class AgentsSnippetTest(unittest.TestCase):
    def test_build_agents_snippet(self) -> None:
        ...
        self.assertIn("memagent recall", snippet)
        self.assertIn("--trace", snippet)
        self.assertIn("--show-sources --show-reasons", snippet)
        self.assertIn("--strategy bm25", snippet)
        self.assertIn("memagent remember", snippet)
        self.assertIn("memagent handoff", snippet)
        self.assertIn("memagent ingest", snippet)
        self.assertIn("memagent trace", snippet)
    ...
    def test_agents_snippet_cli(self) -> None:
        ...
        with redirect_stdout(stdout):
            exit_code = main(["agents-snippet"])
        self.assertEqual(exit_code, 0)
        self.assertIn("memagent process", stdout.getvalue())
